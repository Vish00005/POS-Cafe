  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white font-sans selection:bg-indigo-500/30 overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
        ...
        <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-purple-600/10 blur-[130px] rounded-full animate-blob delay-1000" />
        <div className="absolute top-[30%] right-[10%] w-[40%] h-[40%] bg-emerald-600/5 blur-[120px] rounded-full animate-blob delay-2000" />
      </div>
      ...
      <section className="relative pt-32 pb-20 lg:pt-52 lg:pb-32 px-6 lg:px-12 max-w-7xl mx-auto flex flex-col items-center text-center z-10">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-indigo-400 text-[10px] font-black uppercase tracking-[0.2em] mb-10 animate-fade-up">
        ...
        <div className="flex flex-col sm:flex-row gap-5 w-full sm:w-auto animate-fade-up delay-700">
          <button
            onClick={() => navigate("/login")}
        ...
        {/* Hero Visual */}
        <div className="mt-32 relative w-full max-w-6xl animate-fade-up delay-1000">
      ...
      <section id="features" className="py-32 px-6 lg:px-12 max-w-7xl mx-auto">
        <div className="flex flex-col items-center text-center mb-20">
          <h2 className="text-sm font-black text-indigo-400 uppercase tracking-[0.4em] mb-4">
            Elevated Experience
          </h2>
          <h3 className="text-4xl lg:text-6xl font-black tracking-tight max-w-2xl">
            Crafted for the modern palate.
          </h3>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="glass p-10 rounded-[2.5rem] border border-white/5 hover:border-indigo-500/30 transition-all duration-500 group relative overflow-hidden animate-fade-up delay-100">
            ...
            <p className="text-slate-400 font-medium leading-relaxed">
              Skip the line. Orders reach the kitchen milliseconds after you
              tap. Seamless efficiency at its best.
            </p>
          </div>

          <div className="glass p-10 rounded-[2.5rem] border border-white/5 hover:border-purple-500/30 transition-all duration-500 group relative overflow-hidden animate-fade-up delay-200">
            ...
            <p className="text-slate-400 font-medium leading-relaxed">
              No more guessing games. Watch your meal go from preparation to
              completion in real-time.
            </p>
          </div>

          <div className="glass p-10 rounded-[2.5rem] border border-white/5 hover:border-pink-500/30 transition-all duration-500 group relative overflow-hidden animate-fade-up delay-300">
            ...
            <p className="text-slate-400 font-medium leading-relaxed">
              Premium UI meets handpicked delicacies. We treat cafeteria food
      ...
      <footer className="py-20 border-t border-white/5 px-6 lg:px-12">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10">
          ...
          <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest leading-loose text-center md:text-right">
            Built with precision for the modern workplace.
            <br />© 2026 Premium POS Systems by Antigravity.
          </p>
        </div>
      </footer>
    </div>
