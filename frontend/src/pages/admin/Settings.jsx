...
const AdminSettings = () => {
  ...
  const upiLink = settings.upiId
    ? `upi://pay?pa=${settings.upiId}&pn=${encodeURIComponent(settings.upiName || 'Delight Cafe')}&cu=INR`
    : '';
        ...
        {loading ? <div className="flex justify-center py-20"><Spinner size="lg" /></div> : (
          <>
            ...
            <div className="glass rounded-2xl p-5 space-y-4">
              ...
              {[
                { label: 'Cafe Name', key: 'cafeName', placeholder: 'Delight Cafe' },
            ...
            <div className="glass rounded-2xl p-5 space-y-4">
              ...
              {[
                ...
                { label: 'Display Name on QR', key: 'upiName', placeholder: 'Delight Cafe' },
              ].map(({ label, key, placeholder }) => (
                <div key={key}>
                  <label className="block text-xs text-slate-400 mb-1">{label}</label>
              ...
              {settings.upiId && (
                <div className="mt-3 flex items-center gap-5">
                  ...
                  <div className="text-sm space-y-1">
                    <div className="text-white font-medium">{settings.upiName || 'Delight Cafe'}</div>
